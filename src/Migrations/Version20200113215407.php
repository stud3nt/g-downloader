...
final class Version20200113215407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        // parsed_nodes
        $this->addSql('ALTER TABLE parsed_nodes ADD COLUMN parent_node_id MEDIUMINT(8) UNSIGNED DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE parsed_files ADD CONSTRAINT FK__parsed_files__parsed_node FOREIGN KEY (node_id) 
                    REFERENCES parsed_nodes(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT');
    }
